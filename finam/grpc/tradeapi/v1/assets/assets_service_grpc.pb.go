...
func (c *assetsServiceClient) Exchanges(ctx context.Context, in *ExchangesRequest, opts ...grpc.CallOption) (*ExchangesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.tradeapi.v1.assets.AssetsService/Exchanges", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *assetsServiceClient) Assets(ctx context.Context, in *AssetsRequest, opts ...grpc.CallOption) (*AssetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.tradeapi.v1.assets.AssetsService/Assets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *assetsServiceClient) GetAssetParams(ctx context.Context, in *GetAssetParamsRequest, opts ...grpc.CallOption) (*GetAssetParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.tradeapi.v1.assets.AssetsService/GetAssetParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *assetsServiceClient) OptionsChain(ctx context.Context, in *OptionsChainRequest, opts ...grpc.CallOption) (*OptionsChainResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.tradeapi.v1.assets.AssetsService/OptionsChain", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *assetsServiceClient) Schedule(ctx context.Context, in *ScheduleRequest, opts ...grpc.CallOption) (*ScheduleResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.tradeapi.v1.assets.AssetsService/Schedule", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AssetsService_Exchanges_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.tradeapi.v1.assets.AssetsService/Exchanges",
	}
...
func _AssetsService_Assets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.tradeapi.v1.assets.AssetsService/Assets",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AssetsService_GetAssetParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.tradeapi.v1.assets.AssetsService/GetAssetParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AssetsService_OptionsChain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.tradeapi.v1.assets.AssetsService/OptionsChain",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AssetsService_Schedule_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.tradeapi.v1.assets.AssetsService/Schedule",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
